      ...
      <div className="max-w-md w-full space-y-8 glass-panel p-8 md:p-10 relative overflow-hidden">
        ...
        <div className="text-center relative z-10">
          ...
          <p className="mt-2 text-sm text-slate-500">
            Sign up for the data automation dashboard
          </p>
        </div>
        ...
        {success && (
          <div className="p-4 rounded-xl bg-emerald-50 border border-emerald-100 text-emerald-600 text-sm font-medium fade-in text-center">
